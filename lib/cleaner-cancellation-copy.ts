...
const UNDER_12_HOURS_CONSEQUENCES = [
  ...
  'The client will receive a full refund for this booking.',
  'You will not receive payment for this booking.',
  'This under-12-hour cancellation will be recorded as a last-minute cancellation incident on your account. Repeated incidents may result in a reliability strike under the MaidHive policy.',
  'Client refund: full original booking payment',
  'Cleaner payout: €0.00',
] as const
